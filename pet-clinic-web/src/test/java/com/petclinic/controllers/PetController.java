...
//    private static  final String VIEWS_PETS_CREATE_OR_UPDATE_FORM =  "pets/createOrUpdatePetForm";
    ...
    public PetController(@Qualifier("petSDJpaService") PetService petService,
                         @Qualifier("petTypeSDJpaService") PetTypeService petTypeService,
                         @Qualifier("ownerSDJpaService") OwnerService ownerService) {
